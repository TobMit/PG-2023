namespace EditorSiete.Tools
{
    public static class SelectionBox
    {
        ...
        private static bool isTrackerActive;
        public static bool IsTrackerActive { get { return isTrackerActive; } }
        ...
        {
            Rectangle selectorRectangle = new Rectangle(startingMouseLocation.X,
                                              startingMouseLocation.Y,
                                              currentMouseLocation.X - startingMouseLocation.X,
                                              currentMouseLocation.Y - startingMouseLocation.Y);
